 ...
 * @author duat
 */
public class PopupTypeService extends javax.swing.JPanel {

    /**
     * Creates new form PopupTypeService
     */
    ...
    private final TypeServiceDAO tDao;
    ...
    public boolean check(){
        if(tDao.isTypeServiceNameExists(txtName.getText())){
            showMessageFail("Tên loại dịch vụ đã tồn tại");
            return false;
        }
        if(txtCode.getText().isEmpty()){
            showMessageFail("Mã trống!");
            return false;
    ...
    public void deleteT(TypeServices t){
        ...
        if(selectedRow != -1){
            int id = t.getId();
            tDao.deleteTypeService(id);
            getListTypeService(tDao.getListTypeS());
            showMessageSuccess("xóa thành công!!");
        } else {
            showMessageFail("Chọn thông tin để xóa!!");
        }
    }
    ...
    private void initComponents() {
        ...
        tbTypeService.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "", "STT", "Mã LDV", "Tên LDV", "Ngày tạo", "Trạng thái", "Thao tác"
            }
        ) {
        ...
        jProduct.setViewportView(tbTypeService);
        if (tbTypeService.getColumnModel().getColumnCount() > 0) {
            tbTypeService.getColumnModel().getColumn(0).setMinWidth(0);
            tbTypeService.getColumnModel().getColumn(0).setMaxWidth(0);
        }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jProduct, javax.swing.GroupLayout.DEFAULT_SIZE, 395, Short.MAX_VALUE)
        );
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(jProduct, javax.swing.GroupLayout.DEFAULT_SIZE, 197, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private com.petshop.swing.table.Table tbTypeService;
