...
public class LoginFrame extends javax.swing.JFrame {
    ...
    public LoginFrame() {
        ...
        String savedUsername = rememberMeService.getUsername();
        String savedPassword = rememberMeService.getPassword();
    ...
    public boolean checkLogin() {
        ...
        if (account != null) {
            String usernameAcount = account.getUserName();
            String employeeName = account.getEmployee().getEmployeeName();
            int employeeId = account.getEmployee().getId(); // Lấy ID nhân viên

            if (cbRemember.isSelected()) {
                rememberMeService.saveLoginInfo(username, password);
            } else {
                rememberMeService.clearLoginInfo();
            }

            rememberMeService.saveIdEmployee(employeeId);
            
            // Mở giao diện chính và hiển thị thông tin
            Main mainForm = new Main();
            Main.isLoggedIn = true;
            mainForm.getHeader().setUserName(employeeName);
            mainForm.getHeader().setLbAccount(usernameAcount);
            mainForm.setVisible(true);
            this.dispose();

            return true;
        } else {
            showMessageFail("Username hoặc Password không đúng!!!");
            return false;
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/petshop/icon/banner.jpg"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/petshop/icon/icons8-close-15.png"))); // NOI18N
        ...
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 0, 30, 29));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/petshop/icon/icons8_user_20px_1.png"))); // NOI18N
        ...
        disable.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/petshop/icon/icons8_invisible_20px_1.png"))); // NOI18N
        ...
        show.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/petshop/icon/icons8_eye_20px_1.png"))); // NOI18N
        ...
        cbRemember.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        cbRemember.setForeground(new java.awt.Color(199, 226, 255));
        cbRemember.setText("Ghi nhớ");
