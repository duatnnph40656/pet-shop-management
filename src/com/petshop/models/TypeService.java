...
public class TypeService {
    ...
    public TypeService(int id, String typeServiceCode, String typeServiceName, Date createdAt, boolean deleted, boolean status) {
        this.id = id;
    ...
    public TypeService(String typeServiceCode, String typeServiceName, boolean deleted, boolean status) {
        this.typeServiceCode = typeServiceCode;
        this.typeServiceName = typeServiceName;
        this.deleted = deleted;
        this.status = status;
