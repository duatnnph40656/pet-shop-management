...
public class Products {
    ...
    private CategoryProducts categoryProduct;
    ...
    public Products(int id, String productCode, String productName, CategoryProducts categoryProduct, BigDecimal priceBase, Date createdAt, boolean isDeleted, boolean isStatus) {
        this.id = id;
    ...
    public Products(String productCode, String productName, CategoryProducts categoryProduct, BigDecimal priceBase, boolean isDeleted, boolean isStatus) {
        this.productCode = productCode;
        this.productName = productName;
        this.categoryProduct = categoryProduct;
        this.priceBase = priceBase;
    ...
    public void setCategoryProduct(CategoryProducts categoryProduct) {
        this.categoryProduct = categoryProduct;
    }
