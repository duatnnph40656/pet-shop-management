...
public class TypePets {
    ...
    public TypePets(int id, String typePetCode, String typePetName) {
        this.id = id;
        this.typePetCode = typePetCode;
        this.typePetName = typePetName;
    }

    public TypePets(int id, String typePetCode, String typePetName, Date createdAt, boolean deleted, boolean status) {
        this.id = id;
        this.typePetCode = typePetCode;
        this.typePetName = typePetName;
    ...
    public TypePets(String typePetCode, String typePetName, boolean deleted, boolean status) {
        this.typePetCode = typePetCode;
        this.typePetName = typePetName;
        this.deleted = deleted;
        this.status = status;
