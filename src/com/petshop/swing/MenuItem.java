...
public class MenuItem extends javax.swing.JPanel {
    ...
    public MenuItem(ModelMenu menu, EventMenu event, EventMenuSelected eventSelected, int index) {
        ...
        this.index = index;
        setOpaque(false);
        setLayout(new MigLayout("wrap, fillx, insets 0", "[fill]", "[fill, 40!]0[fill, 30!]0[]")); // Adding '0' for spacing
        MenuButton firstItem = new MenuButton(menu.getIcon(), "      " + menu.getMenuName());
        firstItem.setFont(new Font("Arial", Font.BOLD, 14));  
        firstItem.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);  
        firstItem.setVerticalAlignment(javax.swing.SwingConstants.CENTER);
