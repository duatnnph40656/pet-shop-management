...
import com.petshop.daos.PetDAO1;
...
import com.petshop.popup.PopupDeleteHistory;
...
//        return petFirst.getTypePet().getId() == p.getTypePet().getId()
//                    && petFirst.getBreed().equals(p.getBreed())
//                    && petFirst.getPetName().equals(p.getPetName())
//                    && petFirst.getAge().equals(p.getAge())
//                    && BIg(petFirst.getWeight(), p.getWeight()) == 0
//                    && petFirst.getColor().equals(p.getColor())
//                    && petFirst.isGender() == p.isGender()
//                    && petFirst.isVaccinated() == p.isVaccinated()
//                    && petFirst.getCustomer().getId() == p.getCustomer().getId()
//                    && petFirst.getOwner().equals(p.getOwner());
//    }
